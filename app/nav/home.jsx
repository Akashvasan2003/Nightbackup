...
import * as Notifications from "expo-notifications"; // 🔹 Merged Code
...
const HomeScreen = () => {
  ...
  useEffect(() => {
    registerForPushNotifications(); // 🔹 Merged Code
  }, []);

  // 🔹 Merged Code: Notification Setup
  async function registerForPushNotifications() {
    ...
    try {
      const token = await getToken(messaging, {
        vapidKey: "5d165931d9d9b29c09175541871681551dcdd21a",
      });
